(function () {
    ...
    function decodeBase32(encoded) {
        ...
        for (let i = 0; i < input.length; i++) {
            ...
            bitCount += 5;
            if (bitCount >= 8) {
                output[byteIndex++] = (bitBuffer >>> (bitCount - 8)) & 255;
                bitCount -= 8;
            }
        }
    ...
    function generateTOTP(secret) {
        ...
        try {
            ...
            const timeCounter = Math.floor(Date.now() / 1e3 / 30);
            ...
            return crypto.subtle
                ...
                .then((signature) => {
                    ...
                    const code =
                        ...
                        ((sigBytes[offset + 1] & 255) << 16) |
                        ((sigBytes[offset + 2] & 255) << 8) |
                        (sigBytes[offset + 3] & 255);
