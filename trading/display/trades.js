(function () {
    ...
    const {
        ...
        TradeDisplayPagination: TradeDisplayPagination,
    ...
    const getStoredTrades = (id, fallback) => window[getTradesKey(id)] || fallback;
    ...
    const renderTrades = (trades, id) =>
        trades.map((t) => TradeDisplayRenderer.renderCard(t, id)).join('');
