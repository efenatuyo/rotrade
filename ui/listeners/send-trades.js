(function () {
            ...
            (e) => {
                ...
                const isNextBtn =
                    ...
                    (target.id === 'pagination-next' ||
                        (target.closest && target.closest('#pagination-next')));
                const isPrevBtn =
                    target &&
                    (target.id === 'pagination-prev' ||
                        (target.closest && target.closest('#pagination-prev')));
                if (isNextBtn) {
                    e.preventDefault();
                    e.stopPropagation();
                    const nextBtn = document.getElementById('pagination-next');
    ...
    window.EventListenersSendTrades = {
        setupSendTradesEventListeners: setupSendTradesEventListeners,
    };
