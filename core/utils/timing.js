(function () {
    ...
    function debounce(func, wait, options = {}) {
        const { leading: leading = false, trailing: trailing = true, maxWait: maxWait } = options;
        let timeoutId;
        let maxTimeoutId;
        let lastCallTime;
        ...
        debounced.flush = () => (timeoutId === undefined ? result : trailingEdge(Date.now()));
    ...
    function throttle(func, wait, options = {}) {
        const { leading: leading = true, trailing: trailing = true } = options;
        let timeoutId;
        let lastCallTime;
        let lastInvokeTime = 0;
        let lastArgs;
        ...
        throttled.flush = () => (timeoutId === undefined ? result : trailingEdge(Date.now()));
