(function () {
    ...
    window.TradeStorage = {
        saveTradeToPending: saveTradeToPending,
        saveTradeAfterSending: saveTradeAfterSending,
        refreshOutboundTrades: refreshOutboundTrades,
    };
})();
